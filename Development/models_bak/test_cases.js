...
function test_case_create_user(){
	// Test case create User 
	var uo  =UserSchema.methods.create_user(
			{	 
				"password":"nishu" , 
...
function test_case_get_user(email="nishu.saxena@gmail.com"){
	//Test case get User 
	var uo=UserSchema.methods.get_user({"email":email})
	return uo;
}

function test_case_approve_user(userObj,status){
	var userObj=UserSchema.methods.get_user({"email":email})
