        ...
        if (popup) {
          var modalInstance = $modal.open({
            ...
            resolve: {
              ...
              roletype: function() {
                return $scope.gridUserData[removeIndex].company[
                  'roletype'];
              }
            }
          });
...
angular.module('pinApp')
  .controller('AssignRoleCtrl', function($scope, $modalInstance, $rootScope,
    ...
    userid, removeIndex, commentvisible, roletype, $templateCache, $route) {
    $scope.userupdate = {
