  ...
  .controller('ArticleCtrl', function($scope, $compile, Auth, $location,
    ...
    $scope.color = {
      'Architect Blueprint': {
        ...
        'videoheightclass': 'video-height-yallow',
        'bodyClass': 'blueprint'
      },
      'Essentials Foundation': {
        ...
        'videoheightclass': 'video-height-red',
      ...
      'Growth Pillars': {
        ...
        'videoheightclass': 'video-height-blue',
        'bodyClass': 'growth'
      },
      'Freedom Slab': {
        ...
        'videoheightclass': 'video-height-green',
        'bodyClass': 'freedom'
      },
      'Fun Money Roof': {
        'caption': 'caption-pink',
    ...
    if ($location.path() == "/articles/view/" + articles._id && articles.thumblemedia) {
      ...
      $scope.config = {
        ...
        'plugins': {
          'poster': $sce.trustAsResourceUrl('../' + articles.thumblemedia.path)
        }
      };
