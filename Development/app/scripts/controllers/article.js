...
$scope.addComment=function(form){
 ...
 if(form.$valid)
 {
    var comment={ user: $rootScope.currentUser._id ,username:$rootScope.currentUser.name || $rootScope.currentUser.username, post: $scope.article.comment};
    ...
    success(function (data, status, headers, config) {
          ...
          $scope.comments.push({ user:{ _id: $rootScope.currentUser._id,fullname:$rootScope.currentUser.fullname,following:$rootScope.currentUser.following },username:$rootScope.currentUser.name || $rootScope.currentUser.username, post: $scope.article.comment,posted : new Date()});
...
if(form.$valid)
 {
  var comment={ post: editcomment,username:$rootScope.currentUser.name || $rootScope.currentUser.username,user:$rootScope.currentUser._id};
