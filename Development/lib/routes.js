				...
				if(articleId.length === 4)
				{
					...
					if(cid){
						...
						discussions.checkcid(req,res).then(function(data){
							data=data[0];
						 console.log(data);
						 res.send('<meta property="og:type" content="article">   <meta property="og:site_name" content="Private Investor Network"> <meta property="og:url" content="'+fullUrl+'"> <meta property="og:title" content="'+data.title+'"> <meta property="og:description" content="'+striptags(data.title)+ " --- "+ data.topic +'"> <meta property="og:image" content="http://themoneyhans.com/images/hunsi-img.png"><meta name="twitter:card" content="summary_large_image"/> <meta name="twitter:description" content="'+striptags(data.title)+ " --- "+ data.topic +'"/> <meta name="twitter:title" content="'+data.title+'"/> <meta name="twitter:site" content="@maddyzonenews"/> <meta name="twitter:domain" content="he Money Hans"/> <meta name="twitter:image:src" content="http://themoneyhans.com/images/hunsi-img.png"/>');
					 });
					}
				}
				else
				{
						res.send('<meta property="og:type" content="article"><meta name="keywords" content="wealth ,family office ,single family office ,asset management ,Hansi ,Hansi Mehrotra ,investments ,financial planning ,Mutual funds ,Insurance ,best mutual fund ,behavioural finance ,value investing ,economy ,how to select mutual funds ,portfolio construction ,credit ratings"><meta property="og:site_name" content="Private Investor Network"> <meta property="og:url" content="'+fullUrl+'"> <meta property="og:title" content="Connecting Indian family offices"> <meta property="og:description" content="Networking and content to grow and protect wealth for Indian family offices and UHNI families, edited by Hansi Mehrotra, #LinkedInTopVoices"> <meta property="og:image" content="http://indianpin.net/images/logo.png"><meta name="twitter:card" content="summary_large_image"/> <meta name="twitter:description" content="Networking and content to grow and protect wealth for Indian family offices and UHNI families, edited by Hansi Mehrotra, #LinkedInTopVoices"/> <meta name="twitter:title" content="Connecting Indian family offices"/> <meta name="twitter:site" content="@TheMoneyHans"/> <meta name="twitter:domain" content="he Money Hans"/> <meta name="twitter:image:src" content="http://indianpin.net/images/logo.png"/>');
				}
			}
			 else {
