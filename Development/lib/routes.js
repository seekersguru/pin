				...
				if(articleId.length === 4)
				{
					...
					else if(articleId[1] === 'company')
					{
					 req['params']['companyid']=articleId[3];
						companys.show(req,res).then(function(data){
							console.log(data);
